...
*redux-mvc* allows to setup a global context that can be accesible from every other child context. It is useful to put any data or state that will be reused among contexts.
